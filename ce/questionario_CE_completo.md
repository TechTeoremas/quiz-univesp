...
- **Gabarito:** B
- **Fonte(s) PDF:** Semana 1/s1_videoaula1.pdf; Semana 1/s1_texto_base-introducao_a_programacao_paralela_e_distribuida.pdf
...
- **Enunciado:** A fórmula básica de speedup é:
  ...
  - **B.** Tempo serial / tempo paralelo.
  - **C.** Número de threads / tempo de comunicação.
  - **D.** Tempo de sincronização / tempo total.
  - **E.** Eficiência / número de processadores.
- **Gabarito:** B
- **Fonte(s) PDF:** Semana 1/s1_videoaula2.pdf
...
- **Gabarito:** B
- **Fonte(s) PDF:** Semana 1/s1_texto_base-introducao_a_programacao_paralela_e_distribuida.pdf
...
- **Enunciado:** Por que a ausência de relógio global é um problema importante em sistemas distribuídos?
  ...
  - **B.** Porque dificulta ordenar eventos e coordenar ações com precisão entre máquinas.
  - **C.** Porque obriga todos os computadores a ficarem desligados.
...
- **Enunciado:** Na classificação de Flynn, SISD significa:
  - **A.** Uma instrução, um dado.
  - **B.** Uma instrução, múltiplos dados.
  - **C.** Múltiplas instruções, um dado.
  - **D.** Múltiplas instruções, múltiplos dados.
  - **E.** Sem instruções e sem dados.
- **Gabarito:** A
- **Fonte(s) PDF:** Semana 2/s2_revisitando_aula_01_introducao_programacao_concorrente.pdf
...
- **Enunciado:** Associe: 1) SISD; 2) SIMD; 3) MISD; 4) MIMD. a) Uma instrução/um dado; b) Uma instrução/múltiplos dados; c) Múltiplas instruções/um dado; d) Múltiplas instruções/múltiplos dados.
  ...
  - **E.** 1-c, 2-d, 3-a, 4-b
- **Gabarito:** A
- **Fonte(s) PDF:** Semana 2/s2_revisitando_aula_01_introducao_programacao_concorrente.pdf; Semana 2/s2_videoaula3.pdf
...
- **Enunciado:** Multithreading de granularidade fina alterna threads:
  - **A.** Com alta frequência, até entre instruções.
  - **B.** Apenas quando o computador reinicia.
  - **C.** Somente quando há falha permanente.
  - **D.** Nunca alterna threads.
  - **E.** Somente em sistemas sem cache.
- **Gabarito:** A
- **Fonte(s) PDF:** Semana 2/s2-Texto Base 2 - paralelismo_no_nivel_de_threads.pdf
...
- **Gabarito:** A
- **Fonte(s) PDF:** Semana 2/s2_revisitando_aula_01_introducao_programacao_concorrente.pdf; Semana 2/s2_videoaula4.pdf
...
- **Enunciado:** SIMD é especialmente adequado para:
  - **A.** Aplicar a mesma operação sobre muitos dados, como vetores ou matrizes.
  ...
  - **E.** Substituir completamente sistemas operacionais.
- **Gabarito:** A
- **Fonte(s) PDF:** Semana 2/s2_revisitando_aula_01_introducao_programacao_concorrente.pdf; Semana 2/s2_videoaula4.pdf
...
- **Enunciado:** O maior risco de usar threads com memória compartilhada sem controle é:
  - **A.** Condições de corrida e inconsistência de dados.
  ...
  - **E.** Conversão automática para computação em nuvem.
- **Gabarito:** A
- **Fonte(s) PDF:** Semana 2/S2-Sistemas Op Mod- 3ª Ed- 325-331.pdf; Semana 2/s2-SO Modernos 4 ed- 67-73.pdf
...
- **Gabarito:** A
- **Fonte(s) PDF:** Semana 3/s3_texto_base_cluster_computacao_de_alto_desempenho.pdf; Semana 3/s3_texto_base_aspectos_tecnicos_envolvidos_na_construcao_de_um_cluster.pdf
...
- **Enunciado:** Um cluster Beowulf ficou conhecido por:
  - **A.** Usar PCs comuns, Linux e rede para obter alto desempenho com baixo custo.
  - **B.** Usar apenas supercomputadores proprietários caríssimos.
  - **C.** Proibir programação paralela.
  - **D.** Ser uma tecnologia exclusiva de celulares.
  - **E.** Eliminar a necessidade de hardware.
- **Gabarito:** A
- **Fonte(s) PDF:** Semana 3/s3_texto_base_aspectos_tecnicos_envolvidos_na_construcao_de_um_cluster.pdf
...
- **Enunciado:** Computação em nuvem caracteriza-se principalmente por:
  - **A.** Oferta de recursos computacionais sob demanda pela rede.
  - **B.** Uso obrigatório de um único computador local.
  - **C.** Ausência total de virtualização.
  - **D.** Proibição de escalabilidade.
  - **E.** Execução sem servidores físicos.
- **Gabarito:** A
- **Fonte(s) PDF:** Semana 3/s3_texto_base_computacao_em_nuvem.pdf
...
- **Enunciado:** Associe: 1) Cluster; 2) Grid; 3) Nuvem; 4) Beowulf. a) Recursos heterogêneos e distribuídos entre organizações; b) PCs comuns em rede para HPC; c) Recursos sob demanda; d) Máquinas próximas cooperando como sistema.
  ...
  - **E.** 1-d, 2-c, 3-a, 4-b
- **Gabarito:** A
- **Fonte(s) PDF:** Semana 3/s3_texto_base_cluster_computacao_de_alto_desempenho.pdf; Semana 3/s3_texto_base_grades_computacionais.pdf; Semana 3/s3_texto_base_computacao_em_nuvem.pdf; Semana 3/s3_texto_base_aspectos_tecnicos_envolvidos_na_construcao_de_um_cluster.pdf
...
- **Enunciado:** Em clusters, bibliotecas como MPI são importantes porque:
  - **A.** Permitem comunicação por passagem de mensagens entre processos/nós.
  - **B.** Substituem o hardware de rede.
  - **C.** Criam automaticamente qualquer algoritmo paralelo.
  - **D.** Eliminam latência de comunicação.
  - **E.** Impedem uso de Linux.
- **Gabarito:** A
- **Fonte(s) PDF:** Semana 3/s3_texto_base_aspectos_tecnicos_envolvidos_na_construcao_de_um_cluster.pdf; Semana 3/s3_videoaula5.pdf
...
- **Enunciado:** I) Clusters podem melhorar desempenho. II) Clusters exigem interconexão entre nós. III) Em clusters, comunicação nunca tem custo.
  ...
  - **E.** F, F, F
- **Gabarito:** B
- **Fonte(s) PDF:** Semana 3/s3_texto_base_cluster_computacao_de_alto_desempenho.pdf; Semana 3/s3_videoaula5.pdf
...
- **Gabarito:** A
- **Fonte(s) PDF:** Semana 3/s3_texto_base_grades_computacionais.pdf
...
- **Enunciado:** Em um cluster Beowulf, a escolha da rede é crítica porque:
  - **A.** A comunicação entre nós pode limitar o ganho paralelo.
  - **B.** A rede substitui completamente os processadores.
  - **C.** O sistema não usa mensagens.
...
- **Enunciado:** Uma diferença central entre cluster e nuvem é:
  - **A.** Cluster costuma ser infraestrutura controlada/local; nuvem oferece recursos abstratos e elásticos como serviço.
  - **B.** Nuvem nunca usa servidores físicos.
  - **C.** Cluster não pode executar tarefas paralelas.
  - **D.** Nuvem não permite escalabilidade.
  - **E.** Cluster sempre é mundial e heterogêneo.
- **Gabarito:** A
- **Fonte(s) PDF:** Semana 3/s3_texto_base_cluster_computacao_de_alto_desempenho.pdf; Semana 3/s3_texto_base_computacao_em_nuvem.pdf
...
- **Enunciado:** I) Virtualização favorece consolidação e elasticidade na nuvem. II) Grid envolve coordenação entre domínios administrativos. III) Cluster Beowulf depende apenas de software, sem hardware de rede.
  ...
  - **E.** F, F, F
- **Gabarito:** B
- **Fonte(s) PDF:** Semana 3/s3_texto_base_computacao_em_nuvem.pdf; Semana 3/s3_texto_base_grades_computacionais.pdf; Semana 3/s3_texto_base_aspectos_tecnicos_envolvidos_na_construcao_de_um_cluster.pdf
...
- **Gabarito:** A
- **Fonte(s) PDF:** Semana 4/s4_texto_base_openmp.pdf
...
- **Gabarito:** A
- **Fonte(s) PDF:** Semana 4/s4_texto_base_introducao_a_cuda.pdf
...
- **Enunciado:** Mineração de criptomoedas envolve:
  - **A.** Realizar cálculos computacionais para validar blocos/transações em certos mecanismos de consenso.
  - **B.** Imprimir dinheiro físico.
  - **C.** Criar arquivos PDF.
  - **D.** Desligar todos os computadores da rede.
  - **E.** Evitar completamente gasto de energia.
- **Gabarito:** A
- **Fonte(s) PDF:** Semana 4/s4-Mineração de criptomoedas_ guia simples e rápido - Blog Nubank_ - [blog.nubank.com.br].pdf
...
- **Enunciado:** Associe: 1) OpenMP; 2) CUDA; 3) GPU; 4) Kernel. a) Função executada em paralelo na GPU; b) Diretivas para threads em memória compartilhada; c) Processador massivamente paralelo; d) Plataforma NVIDIA.
  ...
  - **E.** 1-b, 2-a, 3-d, 4-c
- **Gabarito:** A
- **Fonte(s) PDF:** Semana 4/s4_texto_base_openmp.pdf; Semana 4/s4_texto_base_introducao_a_cuda.pdf
...
- **Enunciado:** I) GPUs são boas para tarefas com muito paralelismo de dados. II) CUDA dispensa transferência de dados entre CPU e GPU. III) OpenMP é comum em memória compartilhada.
  ...
  - **E.** F, F, V
- **Gabarito:** B
- **Fonte(s) PDF:** Semana 4/s4_texto_base_introducao_a_cuda.pdf; Semana 4/s4_texto_base_openmp.pdf
...
- **Enunciado:** Uma limitação comum de programas paralelos é:
  - **A.** Overhead de comunicação e sincronização.
  - **B.** Impossibilidade de usar qualquer laço.
  - **C.** Obrigação de rodar sem memória.
  - **D.** Ausência de entrada e saída.
  - **E.** Incompatibilidade com todos os sistemas operacionais.
- **Gabarito:** A
- **Fonte(s) PDF:** Semana 4/s4_texto-base_introducao_a_computacao_paralela.pdf
...
- **Gabarito:** A
- **Fonte(s) PDF:** Semana 4/s4_texto_base_introducao_a_cuda.pdf; Semana 4/s4_videoaula10.pdf
...
- **Enunciado:** Em mineração por prova de trabalho, o paralelismo é útil porque:
  - **A.** Muitas tentativas independentes podem ser testadas simultaneamente.
  - **B.** Cada tentativa precisa esperar todas as anteriores.
  - **C.** O algoritmo proíbe GPUs.
  - **D.** Não há cálculo envolvido.
  - **E.** A rede não valida blocos.
- **Gabarito:** A
- **Fonte(s) PDF:** Semana 4/s4-Mineração de criptomoedas_ guia simples e rápido - Blog Nubank_ - [blog.nubank.com.br].pdf; Semana 4/s4_texto_base_introducao_a_cuda.pdf
...
- **Enunciado:** I) OpenMP é mais natural em memória compartilhada. II) CUDA exige pensar na hierarquia de memória da GPU. III) Paralelismo sempre gera speedup linear perfeito.
  ...
  - **E.** F, F, F
- **Gabarito:** B
- **Fonte(s) PDF:** Semana 4/s4_texto_base_openmp.pdf; Semana 4/s4_texto_base_introducao_a_cuda.pdf; Semana 4/s4_texto-base_introducao_a_computacao_paralela.pdf
...
- **Enunciado:** No padrão publish-subscribe:
  - **A.** Publicadores enviam eventos para tópicos, e assinantes recebem os eventos de interesse.
  - **B.** Todos os componentes precisam conhecer diretamente todos os destinatários.
  - **C.** Não existem consumidores.
...
- **Enunciado:** Apache Kafka é conhecido como:
  - **A.** Plataforma distribuída de streaming/eventos baseada em tópicos e logs.
  - **B.** Editor de imagens.
...
- **Enunciado:** Hadoop é associado principalmente a:
  - **A.** Armazenamento e processamento distribuído de grandes volumes de dados.
  - **B.** Renderização 3D em navegador.
  - **C.** Mineração exclusiva de criptomoedas.
  - **D.** Substituição de todos os sistemas de arquivos locais por PDF.
  - **E.** Comunicação Bluetooth.
- **Gabarito:** A
- **Fonte(s) PDF:** Semana 5/s5_texto_base_apache_hadoop.pdf
...
- **Enunciado:** Apache Spark diferencia-se por:
  - **A.** Processamento distribuído rápido, frequentemente em memória, para batch e streaming.
  - **B.** Ser apenas um editor de texto.
  - **C.** Exigir que todos os dados caibam em uma planilha local.
  - **D.** Não executar em clusters.
  - **E.** Eliminar completamente programação.
- **Gabarito:** A
- **Fonte(s) PDF:** Semana 5/s5_texto_base_apache_spark.pdf
...
- **Enunciado:** A rápida aceitação do Pix está relacionada, entre outros fatores, a:
  - **A.** Infraestrutura digital, disponibilidade, integração bancária e experiência de uso simples.
  - **B.** Funcionamento apenas em horário bancário.
  - **C.** Ausência de sistemas distribuídos.
  - **D.** Proibição de APIs.
...
- **Enunciado:** I) Pub/Sub reduz acoplamento temporal e espacial. II) Kafka pode reter eventos para consumo posterior. III) Spark e Hadoop não têm relação com big data.
  ...
  - **E.** F, F, F
- **Gabarito:** B
- **Fonte(s) PDF:** Semana 5/s5-Padrão de Publisher-Subscriber - Azure Architecture Center - Microsoft.pdf; Semana 5/s5-O que é Apache Kafka.pdf; Semana 5/s5_texto_base_apache_hadoop.pdf; Semana 5/s5_texto_base_apache_spark.pdf
...
- **Gabarito:** A
- **Fonte(s) PDF:** Semana 6/s6-Testes de estresse e carga_ conheça os tipos e ferramentas - Prime.pdf; Semana 6/s6-Teste de performance com JMeter - DevMedia.pdf
...
- **Enunciado:** Teste de estresse busca:
  - **A.** Identificar limites e comportamento do sistema além da carga normal.
  - **B.** Garantir que o sistema nunca falhe.
  - **C.** Executar apenas um usuário por vez.
  - **D.** Testar exclusivamente layout.
  - **E.** Medir somente espaço em disco.
- **Gabarito:** A
- **Fonte(s) PDF:** Semana 6/s6-Testes de estresse e carga_ conheça os tipos e ferramentas - Prime.pdf
...
- **Enunciado:** Apache JMeter é usado para:
  - **A.** Testes de performance/carga em aplicações e serviços.
  - **B.** Editar vídeos.
  - **C.** Criar circuitos eletrônicos.
...
- **Gabarito:** A
- **Fonte(s) PDF:** Semana 6/s6_texto_base_SSC0643_e_SSC5872.pdf; Semana 6/s6_videoaula15.pdf
...
- **Enunciado:** I) Testes devem ter cenário e carga bem definidos. II) Resultados de performance dependem do ambiente. III) Uma única execução sempre prova estabilidade definitiva.
  ...
  - **E.** F, F, F
- **Gabarito:** B
- **Fonte(s) PDF:** Semana 6/s6-Teste de performance com JMeter - DevMedia.pdf; Semana 6/s6-Testes de estresse e carga_ conheça os tipos e ferramentas - Prime.pdf
...
- **Gabarito:** A
- **Fonte(s) PDF:** Semana 6/s6_texto_base_SSC0643_e_SSC5872.pdf; Semana 6/s6_videoaula16.pdf
...
- **Enunciado:** Se o tempo de resposta aumenta muito enquanto o throughput estabiliza, isso pode indicar:
  - **A.** Saturação/gargalo em algum recurso do sistema.
  - **B.** Melhoria linear perfeita.
  - **C.** Ausência de carga.
  - **D.** Que não há usuários usando o sistema.
  - **E.** Que a rede foi removida.
- **Gabarito:** A
- **Fonte(s) PDF:** Semana 6/s6_texto_base_SSC0643_e_SSC5872.pdf; Semana 6/s6_videoaula17.pdf
...
- **Enunciado:** I) Teste de pico avalia aumentos súbitos de carga. II) Teste de endurance observa comportamento por longo período. III) Teste de performance deve ignorar taxa de erro.
  ...
  - **E.** F, F, F
- **Gabarito:** B
- **Fonte(s) PDF:** Semana 6/s6-Testes de estresse e carga_ conheça os tipos e ferramentas - Prime.pdf; Semana 6/s6_videoaula18.pdf
...
- **Enunciado:** Docker é usado principalmente para:
  - **A.** Criar e executar aplicações em contêineres.
  - **B.** Editar imagens manualmente.
  - **C.** Substituir toda a Internet.
  - **D.** Criar hardware físico.
  - **E.** Eliminar dependências de software sem empacotá-las.
- **Gabarito:** A
- **Fonte(s) PDF:** Semana 7/s7_revisitando_conhecimentos_docker_e_sua_relacao_com_microservicos.pdf
...
- **Enunciado:** Microserviços são:
  - **A.** Pequenos serviços independentes que compõem uma aplicação maior.
  - **B.** Um único programa monolítico obrigatório.
  - **C.** Arquivos PDF executáveis.
  - **D.** Serviços que não se comunicam nunca.
...
- **Enunciado:** Associe: 1) Imagem; 2) Contêiner; 3) Pod; 4) Route/Ingress. a) Instância em execução; b) Modelo empacotado; c) Exposição de serviço; d) Unidade básica que agrupa contêineres no Kubernetes.
  ...
  - **E.** 1-b, 2-c, 3-a, 4-d
- **Gabarito:** A
- **Fonte(s) PDF:** Semana 7/s7_revisitando_conhecimentos_docker_e_sua_relacao_com_microservicos.pdf; Semana 7/s7-Red Hat OpenShift.pdf
...
- **Gabarito:** A
- **Fonte(s) PDF:** Semana 7/s7-Red Hat OpenShift.pdf; Semana 7/S7-Red Hat OpenShift 4_ O que há de novo e como criar cluster.pdf
...
- **Enunciado:** Um benefício de usar imagens de contêiner é:
  - **A.** Reprodutibilidade do ambiente entre desenvolvimento, teste e produção.
  - **B.** Garantir que bugs nunca ocorram.
  - **C.** Eliminar necessidade de rede em microserviços.
...
- **Enunciado:** Em OpenShift, um cluster normalmente envolve:
  - **A.** Nós de controle e nós de trabalho executando cargas em contêineres.
  - **B.** Um único arquivo de texto sem servidores.
  - **C.** Apenas um navegador web sem backend.
  - **D.** Ausência de rede entre nós.
  - **E.** Proibição de imagens.
- **Gabarito:** A
- **Fonte(s) PDF:** Semana 7/S7-Red Hat OpenShift 4_ O que há de novo e como criar cluster.pdf; Semana 7/s7-Introdução ao Red Hat OpenShift no Azure - Azure Red Hat OpenShift.pdf
...
- **Enunciado:** A relação entre Docker e microserviços é forte porque:
  - **A.** Contêineres facilitam empacotar, isolar e implantar cada serviço independentemente.
